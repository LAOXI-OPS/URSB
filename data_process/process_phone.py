"""处理 Amazon Phones 数据集为 SBCDR 项目格式。

用法: python process_phone.py
输出: data/phone/train.df, val.df, test.df
"""
import json
import pandas as pd
import numpy as np
...
JSONL_PATH = Path("F:/迅雷下载/phones.jsonl")
OUTPUT_DIR = Path("E:/code/reproduce/my_proj/SBCDR_new/data/phone")
TARGET_USERS = 56641
RANDOM_SEED = 42
